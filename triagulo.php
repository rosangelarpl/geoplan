        ...
        <div class="container">
          <div class="col-md-10">
            <form>
              ...
              <img src="images/areatriangulo.png" alt="" class="areatriangulo">
              <img src="images/area.png" alt="" class="formarea">
              <div class="form-group row">
                ...
                <div class="col-sm-4">
                  ...
                  <input class="btn-lg" type="button" value="Calcular" onclick="calcularAreaTriangulo();return true"/>
                </div>
              </div>
              <div class="resultado">
                <div class="form-group row">
